...
*    Estimated:  0.5 hrs   
*    Actual:     0.3 hrs
*      The hardest part was determining how my for loop should be set up.
************************************************************************/
...
float computeAverageLinear(int list[], int num)
{
   ...
   {
      search = list[i];
      iterations += linear(list, num, search);
   }
   averageLinear = (float)iterations / i;
...
float computeAverageBinary(int list[], int num)
{
   ...
   {
      search = list[i];
      iterations += binary(list, num, search);
   }
   averageBinary = float(iterations) / num;
